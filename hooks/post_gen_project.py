...
GITHUB_REPOS_URL = ('https://api.github.com/orgs/'
    '{{cookiecutter.cookiecutter_namespace}}/repos')
{% endif %}
...
REMOTE_REPO_URL = ('https://{{cookiecutter.git_username}}@'
    '{{cookiecutter.remote_provider}}/{{cookiecutter.cookiecutter_namespace}}/'
    '{{cookiecutter.cookiecutter_slug}}.git')
REMOTE_REPO_DATA = {
...
def create_remote_repo():
    ...
    search_param = {'search': '{{cookiecutter.cookiecutter_namespace}}'}
    ...
    for namespace in gitlab_namespaces:
        if namespace.get('name', '') == '{{cookiecutter.cookiecutter_namespace}}':
...
def main():
    setup_license_file()
    setup_git_repo()
    print('\n{{cookiecutter.cookiecutter_slug}} setup successfully!\n\n')
